(function() {
	angular.module('app')
		.controller('collectionContentController', [
			'$scope', '$rootScope', '$stateParams', 'destroyService', 'dialogService', 'siteNavigationService', 'dataService',
			function($scope, $rootScope, $stateParams, destroyService, dialogService, siteNavigationService, dataService) {
